...
import type { WalletInfo, DashboardWidget } from '@/types/dashboard';
import { StyleSheet, Text, TouchableOpacity, View } from 'react-native';
import { DashboardCard } from './DashboardCard';

interface WalletCardProps {
    widget?: DashboardWidget<WalletInfo>;
    onRetry?: () => void;
    onRequestPayout?: () => void;
}

export function WalletCard({ widget, onRetry, onRequestPayout }: WalletCardProps) {
    if (!widget?.data) {
        return <DashboardCard title="Wallet" widget={widget} onRetry={onRetry} />;
    }
    ...
    return (
        <DashboardCard title="Money" widget={widget} onRetry={onRetry}>
